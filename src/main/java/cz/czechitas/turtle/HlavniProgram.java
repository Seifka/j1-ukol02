...
public class HlavniProgram {
    ...
    public void main(String[] args) {
        ...
        nakresliRovnostrannyTrojuhelnik(zofka, 100.0, zlutaBarva);
        zofka.setLocation(80.0, 230.0);
        zofka.turnLeft(90.0);
        nakresliKolecko(zofka, 11.0, modraBarva);
        ...
        nakresliKolecko(zofka, 16, modraBarva);
        zofka.setLocation(350.0, 235.0);
        nakresliKolecko(zofka, 12.0, modraBarva);
        zofka.setLocation(350.0, 138.0);
        nakresliKolecko(zofka, 10.0, modraBarva);
        zofka.setLocation(270.0, 260.0);
        nakresliKolecko(zofka, 4.0, modraBarva);
        ...
        nakresliKolecko(zofka, 5.0, modraBarva);
    ...
    private void nakresliKolecko(Turtle zofka, double polomer, Color barvaCary) {
        nakresliMnohouhelnik(zofka, polomer, 30.0, barvaCary);
